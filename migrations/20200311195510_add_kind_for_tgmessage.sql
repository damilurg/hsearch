...
alter table tg_messages add kind varchar(50)  default '';
-- +goose StatementEnd
...
insert into tg_messages_dg_tmp(created, message_id, offer_id, chat) select created, message_id, offer_id, chat from tg_messages;

drop table tg_messages;

alter table tg_messages_dg_tmp rename to tg_messages;
